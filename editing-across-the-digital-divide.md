...
In spring 2015, I was part of the first Digital Humanities Institute -- Beirut, organised by David Wrisley and Randa el Khatib, where I taught a course on TEI/XML with a focus on local, Arabic-speaking material. I also met Alex Gil, who introduced me to the idea of [*minimal computing*]{.EmphasisCustom custom-style="EmphasisCustom"}
...
The corpus comprises six fully searchable editions: [Muḥammad Kurd ʿAlī]{.persName custom-style="persName"}'s journal [al-Muqtabas]{.Transcription custom-style="Transcription"} (Cairo and Damascus, 1906--18, not to be confused with his newspaper of the same name), [ʿAbd al-Qādir al-Iskandarānī]{.persName custom-style="persName"}'s  [al-Ḥaqāʾiq]{.Transcription custom-style="Transcription"} (Damascus, 1910--12), [Anastās Mārī al-Karmalī]{.persName custom-style="persName"}'s [Lughat al-ʿArab]{.Transcription custom-style="Transcription"} (Baghdad, 1911--14), {--and from Cairo--} [Muḥammad Rashīd Riḍā]{.persName custom-style="persName"}'s [al-Manār]{.Transcription custom-style="Transcription"} (Cairo, 1898--1940), [Anṭūn al-Jumayyil]{.persName custom-style="persName"}'s [al-Zuhūr]{.Transcription custom-style="Transcription"} (Cairo, 1910--{--19--}13), and [ʿAbdallāh Nadīm al-Idrīsī]{.persName custom-style="persName"}'s weekly journal [al-Ustādh]{.Transcription custom-style="Transcription"} (Cairo, 1892--1893).[^cf10]
...
[^tb3]: Size includes [TEI]{.Abbreviation custom-style="Abbreviation"} files and bibliographic metadata ([BibTeX]{.Abbreviation custom-style="Abbreviation"}, [MODS]{.Abbreviation custom-style="Abbreviation"}).
