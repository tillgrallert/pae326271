...
[HTML5]{custom-style="Abbreviation"} is the current standard for structuring and presenting content on the World Wide Web maintained as a "living standard" by the Web Hypertext Application Technology Working Group ([WHATWG]{custom-style="Abbreviation"}), whose members are the leading vendors of web browsers: Apple, Google, Microsoft, and Mozilla. Developed since the  mid-2000s, [HTML5]{custom-style="Abbreviation"} incorporates many aspects of XHTML and introduced much needed, detailed semantics. Most importantly for our discussion, [HTML5]{custom-style="Abbreviation"} added the global `@lang` attribute, which mirrors the earlier `@xml:lang` attribute and allows to explicitly specify the language of a document or parts thereof through the use of [BCP]{custom-style="Abbreviation"} 47 language tags, such as  "ar" for Arabic or "en" for English. Yet, despite having been originally developed {--in 2008--} and being maintained by an industry consortium of leading browser vendors since 2019, no major modern web browser, however, uses the `@lang` attribute in their built-in [CSS]{custom-style="Abbreviation"} for text-alignment or font selection. Even if a website declares its content as being written in Arabic, browsers such as Chrome, Firefox or Safari, do not correctly render the text as right-aligned. The necessary fix requires only a single line of code[^cf2](`*[lang^="ar"] {direction:rtl;}`)---from everyone publishing text in right-to-left scripts on the Web. 

This lack of support is not limited to viewing content. Software for editing [XML]{custom-style="Abbreviation"}, necessary for working on [TEI]{custom-style="Abbreviation"}-encoded editions, from basic text editors to full-scale [XML]{custom-style="Abbreviation"} editors, represent the same attitude in their [CSS]{custom-style="Abbreviation"} to render a more human-friendly view of the XML. The developers of the extremely popular oXygen [XML]{custom-style="Abbreviation"} editor added the relevant CSS for rendering [TEI XML]{custom-style="Abbreviation"} in their "author mode" in 2015 (v17) and in response to our feature request. But this support of correctly rendering Arabic and other rtl languages is limited to TEI XML
...
[^cf3]: Some projects working on languages that have seen script reforms in the twentieth century, such as Turkish, directly transcribe Arabic into Latin script with [HTR]{custom-style="Abbreviation"} [@KirmizialtinWrisley2022AutomatedTranscription].

[^cf4]: The "Open Islamicate Texts Initiative Arabic-script OCR Catalyst Project" ([OpenITI ACOP]{custom-style="Abbreviation"}) will train models for the most frequent fonts and types [@InitiativeOpenITI+2019+TheOpenIslamicate] and their technology will eventually find its way into HathiTrust [@2020+HathiTrustResearchCenter].

[^cf5]: On the environmental cost of machine learning see  @Alkaoud.Syed+2020+OnTheImportance [124]; @Strubell.etal+2019+EnergyAndPolicy; @Baillot.etal+2021+DigitalHumanitiesAnd.

[^cf6]: E.g. [al-Muqtabas]{custom-style="Transcription"} [4 (5/6)](https://openarabicpe.github.io/journal_al-muqtabas/tei/oclc_4770057679-i_41.TEIP5.xml) and [8 (11/12)](https://openarabicpe.github.io/journal_al-muqtabas/tei/oclc_4770057679-i_94.TEIP5.xml).
