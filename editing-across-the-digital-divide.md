...
![Facsimile of the same section as in @fig:muqtabas-6-2-shamela {--[@oclc_4770057679-i_61-div_21.d1e2838]--} from [[EAP]{.Abbreviation custom-style="Abbreviation"}][eap]](assets/images/EAP119_1_4_5_133.jpg){#fig:muqtabas-6-2-133-eap}
...
This paper introduced some of the very practical difficulties of digitising the cultural record of societies of the Global South, namely the predominantly Arabic-speaking communities and multilingual societies of the Eastern Mediterranean. Venturing into the basics of character encoding and rendering, library catalogues and discovery systems, and ultimately mass-digitisation and their genealogies as rooted in the physical and epistemic violence of colonial regimes and hierarchies of power between the Global North and South, I posed that despite having inherently fewer resources at their disposal, those concerned with digitising the Arabic textual cultural record have to constantly negotiate tools and infrastructures ill-suited, if not openly hostile to this task. {--Turning to--} [*Minimal computing*]{.EmphasisCustom custom-style="EmphasisCustom"} provides a framework to tactically address the needs of our scholarly communities with the specific means and the embodied knowledge at hand. 
 Both projects, [Jarāʾid]{.Transcription custom-style="Transcription"} and [*Open Arabic Periodical Editions*]{.EmphasisCustom custom-style="EmphasisCustom"}, show that by creatively {--repurposing and--} combining open or free-to-use and well-established formats, tools, and platforms, one can produce, share, and maintain publicly accessible infrastructures for knowledge about textual artifacts as well as digital editions of said artifacts at very minimal cost beyond our own labour time. The challenges outlined in this chapter, the practical need to think through the epistemological consequences of every tool and format, and the extremely limited resources available to us, resulted in a rather flat tool stack that vastly increased the sustainability of our effort.  


Of course, there remain open ends. Work on such projects is never really finished. Digital editions can always be further enriched with more granular information and knowledge about any cultural artifact can never really be exhaustive. [Jarāʾid]{.Transcription custom-style="Transcription"}, however, has reached a level of comprehensiveness at which we think our collective knowledge about Arabic periodicals first and foremost needs to be integrated into existing infrastructures of knowledge such as (international) authority files and (aggregated) library catalogues. A first step into this direction would be integrating as much of our data as possible into Wikidata. The required labour of mapping our data model to Wikidata is limited but will, at this point, require some basic grant funding or institutional collaboration with a library.
[OpenArabicPE]{.Abbreviation custom-style="Abbreviation"}, on the other hand, resulted in a successful grant application for a two-year Marie Skłodowska-Curie Actions Postdoctoral Fellowship aimed at first computational analyses of the existing corpus as well as using our data as ground truth for {--ML-based--} training [HTR]{.Abbreviation custom-style="Abbreviation"} models for vastly increasing the size of our corpus. However, due the precariousness of the academic job market{-- dominated by outrageously short fixed-term contracts--}, I returned the {--grant--} funding when I got a job-offer for a much longer{--, albeit still--} fixed-term contract in {--a grant-funded--}{++ a larger++} infrastructure project. [OpenArabicPE]{.Abbreviation custom-style="Abbreviation"} will, in consequence, not evolve beyond its current form.
