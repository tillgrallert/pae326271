...
![Geographic distribution of Arabic periodical titles published across South West Asia and North Africa (SWANA) between 1789--1929. The size of the pie charts corresponds to the total number of titles published at a location. Slices show the percentage of known holdings and digitized collections](/Users/Shared/BachUni/BachBibliothek/GitHub/Sihafa/sihafa_visualization/maps/map-example_sf_mena_en-status_scatterpie.png){#fig:map-periodicals-status}
