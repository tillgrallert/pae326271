...
In 2014, I had just finished my PhD on the history of the street in late Ottoman Damascus (1875--1914) and moved to Beirut for a post-doctoral research project on the genealogy of food riots across the predominantly Arabic-speaking Eastern Mediterranean from the nineteenth century to the present [@Grallert+2019]. 
...
[OpenArabicPE]{.Abbreviation custom-style="Abbreviation"}, on the other hand, resulted in a successful grant application for a two-year Marie Skłodowska-Curie Actions Postdoctoral Fellowship aimed at first computational analyses of the existing corpus as well as using our data as ground truth for  training [HTR]{.Abbreviation custom-style="Abbreviation"} models for vastly increasing the size of our corpus. However, due the precariousness of the academic job market, I returned the  funding when I got a job-offer for a much longer fixed-term contract in  a larger infrastructure project. [OpenArabicPE]{.Abbreviation custom-style="Abbreviation"} will, in consequence, not evolve beyond its current form.
